 ...
 */
public class FreesurferRearrangerNodePlugin extends Plugin {
    // The shared instance.
    private static FreesurferRearrangerNodePlugin plugin;

    /**
     * The constructor.
     */
    public FreesurferRearrangerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FreesurferRearrangerNodePlugin getDefault() {
        return plugin;
    }
